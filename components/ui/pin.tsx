  ...
  return (
    ...
    <motion.div className="pointer-events-none w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-60 transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        ...
        <>
          <motion.div className="absolute right-1/2 bg-linear-to-b from-transparent to-cyan-500 translate-y-3.5 w-px h-20 group-hover/pin:h-40 blur-[2px]" />
          <motion.div className="absolute right-1/2 bg-linear-to-b from-transparent to-cyan-500 translate-y-3.5 w-px h-20 group-hover/pin:h-40  " />
